...
export const createCashPayment = tryCatch(
  async (req: IGetUserAuthInfoRequest, res: Response) => {
    ...
    const userUpdate = await User.findByIdAndUpdate(
      { _id: '67a4b380b7053675b57b8c31' }, //
      {
        $push: {
          product_owned: {
            _id: '66b1e778ecaa46a200a6eb83', //
            qr_code: '67a4b380b7053675b57b8c31', //
            reg_type: 'virtual',
            product_type: 'event',
          },
        },
      ...
      { _id: '66b1e778ecaa46a200a6eb83' },
      {
        $push: {
          registered: {
            ...
            ztellar_fee: 46.46,
            payment_mode: 'gcash', //
            date: new Date('2025-02-07T07:51:45.711Z'), //
          },
        },
      },
      { new: true, upsert: true }
    ...
    const savePayment = await Payment.create({
      ...
      reg_type: 'virtual',
      buyer_id: '67a4b380b7053675b57b8c31', //
      payment_mode: 'cash', //
      payment_source: 'paymongo',
      author_payment: 1000,
      ztellar_fee: 46.46, //
      date: new Date('2025-02-07T11:50:45.711Z'), //
    });
